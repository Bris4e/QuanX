...
const specialRegex = [
  /(\d\.)?\d+×/,
  /IPLC|IEPL|Kern|Edge|Pro|Std|Exp|Biz|Fam|Game|Buy|Zx|LB|Game|Cera|Leaseweb|Misaka|Esons|AWS|Owl|BWG|GlobalSSH|Oracle/,
];
const nameclear =
...
const rurekey = {
  ...
  "United States": /USA|United\-States|Los Angeles|San Jose|Silicon Valley|Michigan/g,
